        ...
        options.map(option => (
          <li key={option.value} className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
            <div className="flex items-center ps-3">
              <input
                id={`${option.value}-image-type-option`}
                type="radio"
                value={option.value}
              ...
              />
              <label htmlFor={`${option.value}-image-type-option`} className="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                {option.label}
              </label>
            </div>
          </li>
